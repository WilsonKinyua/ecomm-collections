    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.sliders.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('price_before') ? 'is-invalid' : '' }}" type="text" name="price_before" id="price_before" value="{{ old('price_before', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('price_after') ? 'is-invalid' : '' }}" type="text" name="price_after" id="price_after" value="{{ old('price_after', '') }}" required>
