    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.update", [$product->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('price_before') ? 'is-invalid' : '' }}" type="number" name="price_before" id="price_before" value="{{ old('price_before', $product->price_before) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('price_after') ? 'is-invalid' : '' }}" type="number" name="price_after" id="price_after" value="{{ old('price_after', $product->price_after) }}" step="0.01" required>
